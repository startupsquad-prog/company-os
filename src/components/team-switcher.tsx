        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              variant="gradient"
              className="data-[state=open]:bg-gradient-to-b data-[state=open]:from-[#4A4A4A] data-[state=open]:to-[#363636] data-[state=open]:text-white"
            >
              ...
              <ChevronsUpDown className="ml-auto text-[#CCCCCC]" />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
